...
\end{figure}
While complete depletion of ethylene or gibberellin in fruit cells is biologically unlikely, for simplicity of modelling, we assumed binary input states, representing the presence or absence of each hormone. In the presence of both hormones, only VP16 is produced (Figure 7A), and in the absence of both hormones, only GAL4 is produced (Figure 7B). If only gibberellin is present, neither  VP16 nor GAL4 is produced (Figure 7C), while in the presence of only ethylene, both VP16 and GAL4 are produced (Figure 7D).
...
As seen in Figure 8C, ADH and PDC initially increase sharply in concentration. However, ADH concentration continues to increase while PDC concentration falls then plateaus.
